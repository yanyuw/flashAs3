package  {
	...
	public class Test3 extends Global {
		...
		public function initTest3Content(){
			...
			// var txtRain = [];
			var myTimer:Timer= new Timer(3500, 12); 
		...
		private function completeTest3(isRight: Boolean){
		...
		private function initContent():void{
			...
			var myTimer2:Timer= new Timer(4000, 11); 
			...
			myTimer2.addEventListener(TimerEvent.TIMER_COMPLETE, function(event:TimerEvent){
				trace("onFinish");
				completeTest3(false)
			}); //运行结束后调用
